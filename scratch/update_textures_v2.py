    ...
    for y in range(height):
        for x in range(width):
            ...
            if a > 0:
                ...
                is_red = False
                # Detect red hue (close to 0 or 1.0)
                if s > 0.10 and (h < 0.08 or h > 0.92):
                    is_red = True
                # Detect red dominant
                elif r > 100 and r > g + 12 and r > b + 12:
                    is_red = True
                # Detect bright light red center (high values but R is still highest)
                elif r > 180 and g > 80 and b > 80 and r > g + 30 and r > b + 30:
                    is_red = True
                
                if is_red:
                    # Keep original lightness and saturation, just replace the hue
